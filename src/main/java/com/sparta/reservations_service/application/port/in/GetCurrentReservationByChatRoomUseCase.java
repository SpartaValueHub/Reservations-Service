...
public interface GetCurrentReservationByChatRoomUseCase {
	...
	default Optional<ReservationDetailResultDto> get(String memberUuid, String chatRoomId) {
		return get(memberUuid, chatRoomId, null);
	}

	Optional<ReservationDetailResultDto> get(String memberUuid, String chatRoomId, String productPostUuid);
}
