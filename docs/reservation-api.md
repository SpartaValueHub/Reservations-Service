...
채팅 오른쪽 패널에서 날짜·시간·장소를 정해 예약을 만듭니다. 구매자·판매자 모두 호출할 수 있습니다. Chat·상품 서비스는 조회하지 않습니다.
...
현재 예약의 날짜·시간·장소만 바꿉니다. 같은 행을 업데이트합니다. 새 행을 만들지 않습니다.
...
예약하기: `POST /api/v1/reservations` → 패널은 201 바디로 채움  
